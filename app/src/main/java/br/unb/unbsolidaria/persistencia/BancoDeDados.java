...
public class BancoDeDados {
    ...
    private BancoDeDados () {
        ...
        oportunidades = Arrays.asList(
                ...
                new Oportunidade(4, "Samambaia", 2, "Acessoria Financeira", "Trabalhos voluntários de acessoria", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizacoes.get(4)),
                new Oportunidade(5, "Taguatinga", 4, "Ajude nos gastos", "Trabalhos voluntários de acessoria", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizacoes.get(5)),
                new Oportunidade(6, "Ceilândia", 5, "Doe um Brinquedo", "Trabalhos voluntários de coleta de doações", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizacoes.get(6)),
                new Oportunidade(7, "São Sebastião", 8, "Fazer a Diferença", "Trabalhos voluntários de coleta de doações", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizacoes.get(7)),
                new Oportunidade(8, "Riacho Fundo", 1, "A mudança em nós", "Trabalhos voluntários de sustentabilidade", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizacoes.get(8)),
                new Oportunidade(9, "Núcleo Bandeirante", 2, "Todos pelo mesmo!", "Trabalhos que promovem a igualdade de gênero", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizacoes.get(9)),
                new Oportunidade(10, "Gama", 4, "Education", "Trabalhos voluntários de ensino em escolas públicas", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizacoes.get(10)),
                new Oportunidade(11, "Planaltina", 5, "InfoTudo", "Trabalhos voluntários informação da população", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizacoes.get(11)),
                new Oportunidade(12, "Asa Norte", 8, "Materialize", "Trabalhos voluntários de criação de objetos com materiais reciclados", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizacoes.get(12)),
                new Oportunidade(13, "Santa Maria", 4, "Morata", "Trabalhos voluntários de ajudas humanitárias", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizacoes.get(13)),
                new Oportunidade(14, "Setor Sudoeste", 7, "Você Visível", "Trabalhos voluntários conscientização social", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizacoes.get(14)),
                new Oportunidade(15, "Setor Noroeste", 5, "Saúde Voluntária", "Trabalhos voluntários conscientização social", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizacoes.get(15)),
